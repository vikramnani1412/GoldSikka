...
public class OkKycUpdationTest {

	@Test
	public void kycUpdationTest() throws Exception
	{
		ExcelFileUtility eUtil = new ExcelFileUtility();
		String FatherName = eUtil.readDataFromExcel("Settings",6,1);
		String SpouseName = eUtil.readDataFromExcel("Settings",7,1);
		String AltPhNo = eUtil.readDataFromExcel("Settings",8,1);
		...
		driver.findElement(By.xpath("//a[@routerlink='/settings/kyc']")).click();//button[.=' Update Kyc ']
