...
public class AddressDetailsUpdationDeletionMakingPrimaryTest extends BaseClass{
	...
	@Test(groups = "SettingsPositive" , priority = 1 , invocationCount = 2)
	...
	@Test(groups = "SettingsPositive" , priority = 2)
	public void settingAsPrimaryAddress() throws Exception
	{
		...
		@Test(groups = "SettingsPositive" , priority = 3)
		...
		@Test(groups = "SettingsPositive" , priority = 4)
